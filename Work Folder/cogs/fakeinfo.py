    ...
    async def fake(self, ctx, *, fake_mode="help"):
        ...
        if fake_mode == "high":
            try:
                ...
                emf = discord.Embed(title=getembed.FakeEmbeds.TITLE, color=getembed.FakeEmbeds.COLOR)
                emf.set_footer(text=f"Requested by {ctx.author.name}")
                emf.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME, icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
            ...
            try:
                USname = faker.name()
                emf2 = discord.Embed(title=getembed.FakeEmbeds.TITLE, color=getembed.FakeEmbeds.COLOR)
                emf2.set_thumbnail(url=getembed.FakeEmbeds.THUMBNAIL)
                emf2.set_footer(text=f"Requested by {ctx.author.name}")
                emf2.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME, icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
    ...
    async def mfp(self, ctx, *, how_many):
        ...
        try:
            ...
            if fake_how_many <= 25:
                ...
                embed.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME, icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
