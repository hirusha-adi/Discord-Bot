    ...
    async def chatbot(self, ctx, command="main"):
        ...
        try:
            ...
            if command in old_wl:
                emh1 = discord.Embed(
                    title=f'Chat Bot', description=f'Lonely Bot v2.0', color=getembed.Common.COLOR)
                emh1.set_thumbnail(
                ...
                emh2 = discord.Embed(
                    title=f'Chat Bot', description=f'Main', color=getembed.Common.COLOR)
                emh2.set_thumbnail(
                    url=r"https://cdn.discordapp.com/attachments/863706778743341076/874579616210239488/Avatar.png")
                emh2.add_field(
                ...
                emh3 = discord.Embed(
                    title=f'Chat Bot', description=f'Chatbot History', color=getembed.Common.COLOR)
                emh3.set_thumbnail(
                    url=r"https://cdn.discordapp.com/attachments/863706778743341076/874579616210239488/Avatar.png")
                emh3.add_field(
                ...
                emh4 = discord.Embed(title=f'Chat Bot - Channel List',
                                     description=f'all activated channels', color=getembed.Common.COLOR)
                emh4.set_thumbnail(
                    url=r"https://cdn.discordapp.com/attachments/863706778743341076/874579616210239488/Avatar.png")
                emh4.add_field(
                ...
                emh2 = discord.Embed(
                    title=f'Chat Bot - Help', description=f'Help', color=getembed.Common.COLOR)
                emh2.set_thumbnail(
                    url=r"https://cdn.discordapp.com/attachments/863706778743341076/874579616210239488/Avatar.png")
                emh2.add_field(
                ...
                emh2.add_field(name=f'Old Days',
                               value=f'`{bp}chatbot olddays`', inline=True)
                await loading_message.delete()
                await ctx.send(embed=emh2)
