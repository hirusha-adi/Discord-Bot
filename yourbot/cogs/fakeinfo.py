...
class FakeInformation(commands.Cog, description="Generate fake/random information"):
    ...
    async def face(self, ctx, gender="any"):
        try:
            ...
            embed3.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME,
                              icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
    ...
    async def fake(self, ctx, *, fake_mode="help"):
        ...
        if fake_mode == "high":
            try:
                ...
                emf = discord.Embed(
                    title=getembed.FakeEmbeds.TITLE, color=getembed.FakeEmbeds.COLOR)
                emf.set_footer(text=f"Requested by {ctx.author.name}")
                emf.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME,
                               icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
                emf.set_thumbnail(url=getembed.FakeEmbeds.THUMBNAIL)
            ...
            try:
                ...
                emf2 = discord.Embed(
                    title=getembed.FakeEmbeds.TITLE, color=getembed.FakeEmbeds.COLOR)
                emf2.set_thumbnail(url=getembed.FakeEmbeds.THUMBNAIL)
                emf2.set_footer(text=f"Requested by {ctx.author.name}")
                emf2.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME,
                                icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
            ...
            try:
                ...
                try:
                    ...
                    embed3.set_author(
                        name=getembed.FakeEmbeds.AUTHOR_NAME, icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
                    embed3.set_thumbnail(url=getembed.ErrorEmbeds.THUMBNAIL)
                    embed3.add_field(name="Error:", value=f"{e}", inline=False)
                    embed3.set_footer(text=f"Requested by {ctx.author.name}")
                    await loading_message.delete()
    ...
    async def mfp(self, ctx, *, how_many):
        ...
        try:
            ...
            if fake_how_many <= 25:
                ...
                embed = discord.Embed(
                    title="Mass Fake Profiles", color=0xff0000)
                embed.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME,
                                 icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
                embed.set_thumbnail(url=getembed.FakeEmbeds.THUMBNAIL)
                ...
                embed.set_thumbnail(url=getembed.FakeEmbeds.THUMBNAIL)
                embed.add_field(
                    name="Error", value="Please enter a value below 25; This is done to prevent spam!", inline=True)
                embed.set_footer(text=f"Requested by {ctx.author.name}")
                await loading_message.delete()
                await ctx.send(embed=embed)
    ...
    async def bottoken(self, ctx):
        ...
        try:
            ...
            embed = discord.Embed(
                title="Discord Bot Token Generator", description=f"`{r['token']}`", color=0xff0000)
            embed.set_author(name=getembed.FakeEmbeds.AUTHOR_NAME,
                             icon_url=getembed.FakeEmbeds.AUTHOR_LINK)
            embed.set_thumbnail(
